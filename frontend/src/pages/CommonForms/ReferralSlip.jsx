...
const JILLA = [
  { value: "ktm", label: "काठमाडौं" },
  { value: "bkt", label: "भक्तपुर" },
  { value: "llt", label: "ललितपुर" },
  { value: "pokhara", label: "पोखरा" },
...
export default function ReferralSlip() {
  ...
  const [sanstha1, setSanstha1] = useState({
    naam: "",
    thegana: "",
    samparka: "",
    pradesh: "",
  ...
  const [sanstha2, setSanstha2] = useState({
    naam: "",
    thegana: "",
    samparkMiti: today,
    anyaParikshan: "",
  ...
  const setOf = (f) => (e) =>
    setOfficial((p) => ({ ...p, [f]: e.target.value }));

  const addSewa = () => setSewaRows((r) => [...r, newSewaRow()]);
  const removeSewa = (id) =>
    setSewaRows((r) => (r.length > 1 ? r.filter((x) => x.id !== id) : r));
  const updateSewa = (id, val) =>
    setSewaRows((r) => r.map((x) => (x.id === id ? { ...x, sewa: val } : x)));

  const addAusadhi = () => setAusadhiRows((r) => [...r, newAusadhiRow()]);
  const removeAusadhi = (id) =>
    setAusadhiRows((r) => (r.length > 1 ? r.filter((x) => x.id !== id) : r));
  const updateAusadhi = (id, f, val) =>
    setAusadhiRows((r) => r.map((x) => (x.id === id ? { ...x, [f]: val } : x)));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        fromAddress: sanstha1.thegana,
        fromContact: sanstha1.samparka,
        ...
        bodyType: vitals.prakriti,
        ayurvedaTherapy: vitals.therapy,
        otherNotes: anyaUllekh,

        /* Referred To */
        toInstitutionName: sanstha2.naam,
        toAddress: sanstha2.thegana,
        contactDate: sanstha2.samparkMiti,
        requiredTests: sanstha2.anyaParikshan,
        referralReason: sanstha2.kaaran,

        /* Official */
        officialName: official.naam,
        officialDesignation: official.pad,
        ...
        medicines: ausadhiRows
          .filter((x) => x.ausadhi.trim())
          .map((x) => ({
            medicineName: x.ausadhi,
            dosage: x.matra,
          })),
      };
      ...
      /* Reset Rows */
      setSewaRows([newSewaRow()]);
      setAusadhiRows([newAusadhiRow()]);
      ...
      <div style={S.card}>
        ...
        <div style={S.headerBar}>
          ...
          <span style={S.breadcrumb}>
            ...
            {" / "}प्रेषण / स्थानान्तरण पुर्जि दर्ता
          </span>
        </div>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div style={S.secBody}>
              <div style={S.g2}>
                ...
                <div style={S.lr}>
                  ...
                  <input
                    style={S.input}
                    value={sanstha1.thegana}
                    onChange={setS1("thegana")}
                  />
                </div>
              </div>
              ...
              <div style={S.g2}>
                <div style={S.lr}>
                  ...
                  <input
                    style={S.input}
                    value={sanstha1.samparka}
                    onChange={setS1("samparka")}
                  />
                </div>
                <div style={S.lr}>
            ...
            <div style={S.secBody}>
              ...
              <div style={S.lr}>
                ...
                <input
                  ...
                  value={patient.wadaNumber}
                  onChange={setPt("wadaNumber")}
                />
              </div>
                    ...
                    <tr key={row.id}>
                      ...
                      <td style={S.td}>
                        <input
                          style={S.input}
                          value={row.sewa}
                          onChange={(e) => updateSewa(row.id, e.target.value)}
                        />
                      </td>
                      <td style={S.tdc}>
              ...
              <div style={S.g2}>
                <div style={S.lr}>
                  ...
                  <input
                    style={S.input}
                    value={vitals.prakriti}
                    onChange={setV("prakriti")}
                  />
                </div>
                <div style={S.lr}>
                  ...
                  <input
                    style={S.input}
                    value={vitals.therapy}
                    onChange={setV("therapy")}
                  />
                </div>
              </div>
                    ...
                    <tr key={row.id}>
                      ...
                      <td style={S.td}>
                        <input
                          ...
                          value={row.ausadhi}
                          onChange={(e) =>
                            updateAusadhi(row.id, "ausadhi", e.target.value)
                          }
                        />
                      </td>
                      <td style={S.td}>
                        <input
                          ...
                          value={row.matra}
                          onChange={(e) =>
                            updateAusadhi(row.id, "matra", e.target.value)
                          }
                        />
                      </td>
                      <td style={S.tdc}>
              ...
              <div style={S.lr}>
                ...
                <input
                  style={S.input}
                  value={anyaUllekh}
                  onChange={(e) => setAnyaUllekh(e.target.value)}
                />
              </div>
            </div>
          </div>
          ...
          <div style={S.section}>
            <div style={S.secTitle}>
              प्रेषण / स्थानान्तरण गरिएको स्वास्थ्य संस्थाको विवरण
            </div>
            <div style={S.secBody}>
              <div style={S.g2}>
                <div style={S.lr}>
              ...
              <div style={S.g2}>
                <div style={S.lr}>
                  ...
                  <input
                    style={S.inputRO}
                    value={sanstha2.samparkMiti}
                    readOnly
                  />
                </div>
                <div style={S.lr}>
                  <span style={S.label}>
                    अन्य परिक्षण गर्नुपर्ने भए उल्लेख गर्ने :
                  </span>
                  <input
                    style={S.input}
                    value={sanstha2.anyaParikshan}
                    onChange={setS2("anyaParikshan")}
                  />
                </div>
              </div>
              ...
              <div style={S.lr}>
                ...
                <input
                  style={S.input}
                  value={sanstha2.kaaran}
                  onChange={setS2("kaaran")}
                />
              </div>
            </div>
          </div>
          ...
          <div style={S.section}>
            ...
            <div style={S.secBody}>
              <div style={S.g2}>
                <div style={S.lr}>
                  <span style={S.label}>
                    प्रेषण / स्थानान्तरण गर्नेको नाम :
                  </span>
                  <input
                    style={S.input}
                    value={official.naam}
