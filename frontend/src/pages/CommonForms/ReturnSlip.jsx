...
const S = {
  ...
  lr:          { display: "grid", gridTemplateColumns: "160px 1fr", alignItems: "center", gap: "10px" },
...
export default function ReturnSlip() {
  ...
  const [patient, setPatient] = useState({ naam: "", thar: "", linga: "", umer: "", pradesh: "", wada: "", samparkMiti: today });
  ...
  const removeRow = (id) => setSewaRows((r) => r.length > 1 ? r.filter((x) => x.id !== id) : r);
  const updateRow = (id, val) => setSewaRows((r) => r.map((x) => x.id === id ? { ...x, sewa: val } : x));
      ...
      <div style={S.card}>
        ...
        <div style={S.headerBar}>
          ...
          <span style={S.breadcrumb}>
            <span style={S.bcLink}>गृहपृष्ठ</span>{" / "}फिर्ती पुर्जि दर्ता
          </span>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={S.section}>
            <div style={S.secTitle}>फिर्ती जानकारी दिने स्वास्थ्य संस्थाको विवरण</div>
            <div style={S.secBody}>
              ...
              <div style={S.lr}>
                ...
                <input style={{ ...S.input, maxWidth: "320px" }} value={sanstha1.wada} onChange={setS1("wada")} />
              </div>
          ...
          <div style={S.section}>
            <div style={S.secTitle}>फिर्ती जानकारी पठाइएको स्वास्थ्य संस्थाको विवरण</div>
            <div style={S.secBody}>
          ...
          <div style={S.section}>
            ...
            <div style={S.secBody}>
              ...
              <div style={S.lr}>
                <span style={S.label}>प्रदेश :</span>
                <select style={{ ...S.select, maxWidth: "320px" }} value={patient.pradesh} onChange={setPt("pradesh")}>
                  <option value="">प्रदेश छनोट गर्नहोस</option>
                  {PRADESH.map((o) => <option key={o.value} value={o.value}>{o.label}</option>)}
                </select>
              </div>
              ...
              <div style={S.g2}>
                <div style={S.lr}>
                  <span style={S.label}>वडा नम्बर :</span>
                  <input style={S.input} value={patient.wada} onChange={setPt("wada")} />
                </div>
                <div style={S.lr}>
                  <span style={S.label}>सम्पर्क गर्न आएको मिति :</span>
                  <input style={S.inputRO} value={patient.samparkMiti} readOnly />
                </div>
              </div>
                ...
                <tbody>
                  {sewaRows.map((row, idx) => (
                    <tr key={row.id}>
                      ...
                      <td style={S.td}>
                        <input style={S.input} value={row.sewa} onChange={(e) => updateRow(row.id, e.target.value)} />
                      </td>
                      <td style={S.tdc}>
            ...
            <div style={S.secBody}>
              ...
              <div style={S.g2}>
                <div style={S.lr}>
                  ...
                  <input style={S.input} value={info.naam} onChange={setIn("naam")} />
                </div>
                <div style={S.lr}>
                  <span style={S.label}>पद :</span>
                  <input style={S.input} value={info.pad} onChange={setIn("pad")} />
                </div>
              </div>
              ...
              <div style={S.lr}>
                <span style={S.label}>मिति :</span>
                <input style={{ ...S.inputRO, maxWidth: "320px" }} value={info.miti} readOnly />
              </div>
