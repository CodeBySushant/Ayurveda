...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .sn-cell { width: 36px; font-weight: 600; color: #6b7280; }
  .action-cell { width: 64px; white-space: nowrap; }
  .col-miti { width: 110px; }
  .col-sewa { width: 160px; }
...
const SEWA_OPTIONS = [
  "अपेन्डिक्स शल्यक्रिया",
  "हर्निया शल्यक्रिया",
  "पित्तथैली शल्यक्रिया",
  "थाइरोइड शल्यक्रिया",
  "अर्थोपेडिक शल्यक्रिया",
  "नेत्र शल्यक्रिया",
  "अन्य शल्यक्रिया",
];
...
export default function ShalyaChikitsaServiceRegister() {
    ...
    <>
      ...
      <div className="app-root">
        ...
        <div className="page-header">
          <h1>शल्य चिकित्सा सेवा सृजना</h1>
          <div className="breadcrumb">
            गृहपृष्ठ / <span>शल्य चिकित्सा सेवा सृजना</span>
          </div>
        </div>
                ...
                <table>
                  <thead>
                    <tr>
                      ...
                      <th className="col-miti">मिति</th>
                      <th className="col-sewa">सेवा</th>
                      <th>विवरण</th>
                      <th>जटिलता</th>
                      ...
                      <tr key={row.id}>
                        ...
                        <td>
                          <textarea
                            ...
                            rows={2}
                            value={row.vivaran}
                            onChange={handleServiceChange(row.id, "vivaran")}
                          />
                        </td>
                        <td>
                          <textarea
