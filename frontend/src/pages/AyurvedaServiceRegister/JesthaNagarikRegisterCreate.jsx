...
export default function JesthaNagarikServiceRegister() {
  ...
  const setP = (panel, f) => (e) =>
    setPanels((p) => ({ ...p, [panel]: { ...p[panel], [f]: e.target.value } }));

  const handleSubmit = async (e) => {
    e.preventDefault();

    if (!form.moolDarta.trim()) {
    ...
    return (
      <div style={S.panel}>
        ...
        <div style={S.panelBody}>
          <div style={S.field}>
            <label style={S.label}>मिति</label>
            <input
              style={S.input}
              value={p.miti}
              onChange={setP("pahilo", "miti")}
            />
          </div>
          <div>
            <div style={S.g3}>
            ...
            <div style={{ ...S.g3, marginTop: "5px" }}>
              <input
                ...
                placeholder="मात्रा"
                value={p.ashwagandha}
                onChange={setP("pahilo", "ashwagandha")}
              />
              <input
                style={S.input}
                placeholder="मात्रा"
                value={p.amalaki}
                onChange={setP("pahilo", "amalaki")}
              />
              <input
                style={S.input}
                placeholder="मात्रा"
                value={p.mahanarayan}
                onChange={setP("pahilo", "mahanarayan")}
              />
            </div>
          </div>
          <div style={S.g2}>
            <div style={S.field}>
              <label style={S.label}>उचाइ</label>
              <div style={S.heightRow}>
                <input
                  style={S.input}
                  value={p.ubchadVal}
                  onChange={setP("pahilo", "ubchadVal")}
                />
                <select
                  style={S.select}
                  value={p.ubchadUnit}
                  onChange={setP("pahilo", "ubchadUnit")}
                >
                  {HEIGHT_UNITS.map((u) => (
          ...
          {[
            ...
            >
              ...
              <input
                ...
                placeholder={label}
                value={p[key]}
                onChange={setP("pahilo", key)}
              />
            </div>
          ))}
          <div style={S.field}>
            <label style={S.label}>परीक्षण / सल्लाह</label>
            <input
              style={S.input}
              value={p.parikshan}
              onChange={setP("pahilo", "parikshan")}
            />
          </div>
          <div style={S.field}>
        ...
        <div style={S.panelBody}>
          ...
          <div>
            ...
            <div style={{ ...S.g3, marginTop: "5px" }}>
              <input
                ...
                placeholder="मात्रा"
                value={p.ashwagandha}
                onChange={setP(panelKey, "ashwagandha")}
              />
              <input
                style={S.input}
                placeholder="मात्रा"
                value={p.amalaki}
                onChange={setP(panelKey, "amalaki")}
              />
              <input
                style={S.input}
                placeholder="मात्रा"
                value={p.mahanarayan}
                onChange={setP(panelKey, "mahanarayan")}
              />
            </div>
          </div>
          <div style={S.g2}>
            ...
            <div style={S.field}>
              ...
              <div style={S.heightRow}>
                <input
                  style={S.input}
                  value={p.ubchadVal}
                  onChange={setP(panelKey, "ubchadVal")}
                />
                <select
                  style={S.select}
                  value={p.ubchadUnit}
                  onChange={setP(panelKey, "ubchadUnit")}
                >
                  {HEIGHT_UNITS.map((u) => (
                    <option key={u}>{u}</option>
                  ))}
          ...
          {[
            ...
            <div
              ...
              style={{
                display: "grid",
                gridTemplateColumns: "50px 1fr 50px 50px 50px",
                alignItems: "center",
                gap: "6px",
              }}
            >
          ...
          <div style={S.field}>
            ...
            <input
              style={S.input}
              value={p.parikshan}
              onChange={setP(panelKey, "parikshan")}
            />
          </div>
          <div style={S.field}>
            <label style={S.label}>कैफियत</label>
            <input
              style={S.input}
              value={p.kaifiyat}
              onChange={setP(panelKey, "kaifiyat")}
            />
          </div>
        </div>
      </div>
          ...
          <div style={S.topBox}>
            <div style={S.field}>
              ...
              <input
                ...
                value={form.moolDarta}
                onChange={set("moolDarta")}
              />
            </div>
            <div style={S.g2}>
              <div style={S.field}>
                ...
                <input
                  style={S.input}
                  placeholder="mm Hg"
                  value={form.raktachap}
                  onChange={set("raktachap")}
                />
              </div>
              <div style={S.field}>
                <label style={S.label}>तौल</label>
            ...
            <div style={S.g2}>
              ...
              <div style={S.field}>
                ...
                <input
                  style={S.input}
                  value={form.parikshan}
                  onChange={set("parikshan")}
                />
              </div>
            </div>
          </div>
            ...
            <div style={S.g2}>
              <div style={S.field}>
                ...
                <input
                  ...
                  value={form.samparkNum}
                  onChange={set("samparkNum")}
                />
              </div>
              <div style={S.field}>
