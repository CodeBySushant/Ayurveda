...
const THERAPY_TYPES = ["Others", "Bloodletting", "Acupressure", "Maxibustion", "Cupping", "Acupuncture"];
...
export default function AkupuncharSevaPratiwedan() {
  ...
  return (
    <div style={s.root}>
      {/* Nav */}
      <div style={s.nav}>
        <span style={s.navTitle}>अकुपुञ्चर सेवा प्रतिवेदन</span>
        <span style={s.navBreadcrumb}>
          <a href="#" style={s.navLink}>गृहपृष्ठ</a>
          {" / "}अकुपुञ्चर सेवा प्रतिवेदन
        </span>
      </div>
