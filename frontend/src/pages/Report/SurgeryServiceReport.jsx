...
const SURGERY_TYPES = ["क्षारसुत्र", "अग्निकर्म", "रक्तमोचण", "मर्म उपचार", "विशिष्ट शल्य सेवा", "अन्य शल्य उपचार"];
...
const initData = () =>
  ROW_GROUPS.reduce((acc, g) => {
    acc[g.key] = SURGERY_TYPES.reduce((a, t) => {
      a[t] = { F: 0, M: 0 };
      return a;
    }, {});
    return acc;
...
export default function ShalyaChikitsaSevaPratiwedan() {
  ...
  return (
    <div style={s.root}>
      {/* Nav */}
      <div style={s.nav}>
        <span style={s.navTitle}>शल्य चिकित्सा सेवा प्रतिवेदन</span>
        <span style={s.navBreadcrumb}>
          <a href="#" style={s.navLink}>गृहपृष्ठ</a>
          {" / "}शल्य चिकित्सा सेवा प्रतिवेदन
        </span>
      </div>
      ...
      <div style={s.pageBody}>
        <div style={s.tableWrapper}>
          <table style={s.table}>
            <thead>
              <tr>
                <th colSpan={2 + SURGERY_TYPES.length} style={s.sectionTitleTh}>
                  शल्य चिकित्सा प्रतिवेदन
                </th>
              </tr>
              <tr>
                ...
                GENDERS.map((gender, ri) => {
                  ...
                  return (
                    <tr key={`${group.key}-${gender.key}`}>
                      {ri === 0 && (
                        <td rowSpan={2} style={s.groupLabelTd}>
                          {group.label}
                        </td>
                      )}
