...
const ROWS = [
  { key: "total",   label: "जम्मा स्तनपायी आमाको संख्या",                    alt: true  },
  { key: "m1",      label: "१ महिना भन्दा कम औषधी खाएका आमाहरुको संख्या",    alt: false },
  { key: "m1to2",   label: "१ देखि २ महिना सम्म औषधी खाएका आमाहरुको संख्या", alt: true  },
  { key: "m2to3",   label: "२ देखि ३ महिना सम्म औषधी खाएका आमाहरुको संख्या", alt: false },
  { key: "m3to4",   label: "३ देखि ४ महिना सम्म औषधी खाएका आमाहरुको संख्या", alt: true  },
  { key: "m4to5",   label: "४ देखि ५ महिना सम्म औषधी खाएका आमाहरुको संख्या", alt: false },
  { key: "m5plus",  label: "५ महिना भन्दा बढी औषधी खाएका आमाहरुको संख्या",   alt: true  },
];
...
export default function StanpayiAamaPratiwedan() {
  ...
  const data = ROWS.reduce((acc, r) => { acc[r.key] = 0; return acc; }, {});

  return (
    <div style={s.root}>
      {/* Nav */}
      <div style={s.nav}>
        <span style={s.navTitle}>स्तनपायी आमा तथा शिशु सेवा प्रतिवेदन</span>
        <span style={s.navBreadcrumb}>
          <a href="#" style={s.navLink}>गृहपृष्ठ</a>
          {" / "}स्तनपायी आमा तथा शिशु सेवा प्रतिवेदन
        </span>
      </div>
            ...
            <thead>
              <tr>
                <th colSpan={2} style={s.sectionTitleTh}>
                  ५. स्तनपायी आमा तथा शिशु सेवा प्रतिवेदन
                </th>
              </tr>
              <tr>
                <th style={s.headerTh}>विवरण</th>
                <th style={s.headerThRight}>संख्या</th>
              </tr>
            </thead>
            <tbody>
              {ROWS.map(row => (
                <tr key={row.key}>
                  <td style={s.labelTd(row.alt)}>{row.label}</td>
                  <td style={s.valueTd(row.alt)}>{data[row.key]}</td>
                </tr>
              ))}
            </tbody>
          </table>
